    ...
    <>
      ...
      <div className='destination-container'>
        <div className='info-wrapper'>
          <h2>Explore the maldives wonder</h2>
          <p>Visit maldives, admire the blue oceans, and enjoy a tour while gliding through the blue water and vines to reach glistening rocks and water vapour glinting in the sunlight. Join this real adventurous thrill with us!</p>
